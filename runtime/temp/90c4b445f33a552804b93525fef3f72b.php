<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\wamp64\www\project\iotstudio/application/index\view\cms\changeEssay.html";i:1493993393;s:70:"D:\wamp64\www\project\iotstudio/application/index\view\cms\header.html";i:1494165839;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-2">
            ...
            <a href="<?php echo url('Cms/index'); ?>" class="list-group-item">所有文章</a>
            <a href="<?php echo url('Cms/add').'?type=essay'; ?>" class="list-group-item">添加文章</a>
            <a href="#" class="list-group-item  disabled">修改文章</a>
        </div>
        <div class="col-sm-10">
            <ol class="breadcrumb">
                <li class="active">文章管理
                </li>
                <li class="active">修改文章
                </li>
            </ol>
