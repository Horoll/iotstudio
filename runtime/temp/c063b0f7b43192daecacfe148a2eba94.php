<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\wamp64\www\project\iotstudio/application/index\view\cms\addEssay.html";i:1493993315;s:70:"D:\wamp64\www\project\iotstudio/application/index\view\cms\header.html";i:1494165839;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-2">
            ...
            <a href="<?php echo url('Cms/essay'); ?>" class="list-group-item">所有文章</a>
            <a href="#" class="list-group-item  disabled">添加文章</a>
        </div>
        <div class="col-sm-10">
            <ol class="breadcrumb">
                <li class="active">文章管理
                </li>
                <li class="active">添加文章
                </li>
            </ol>
                ...
                <div class="panel-body">
                    <form role="form" action="<?php echo url('Cms/add'); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="editor" name="text" placeholder="添加文章" autofocus></textarea>
                        </div>
                        <p class="submit-p">
