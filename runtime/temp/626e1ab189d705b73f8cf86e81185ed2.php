<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\wamp64\www\project\iotstudio/application/index\view\cms\addTrend.html";i:1493963488;s:70:"D:\wamp64\www\project\iotstudio/application/index\view\cms\header.html";i:1495203267;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="panel-body">
                    <form role="form" action="<?php echo url('Cms/add'); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="editor" name="text" placeholder="添加动态" autofocus></textarea>
                        </div>
                        <p class="submit-p">
