<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\wamp64\www\project\iotstudio/application/index\view\cms\publication.html";i:1500175816;s:70:"D:\wamp64\www\project\iotstudio/application/index\view\cms\header.html";i:1495203267;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-2">
            ...
            <a href="#" class="list-group-item disabled">所有发表</a>
            <a href="<?php echo url('Cms/add').'?type=publication'; ?>" class="list-group-item">添加发表</a>
        </div>
        <div class="col-sm-10">
            <ol class="breadcrumb">
                <li class="active">发表管理
                </li>
                <li class="active">所有发表
                </li>
            </ol>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php }
                                 endforeach; ?>
                                <td>
                                    <a href="<?php echo url('Read/index').'?type=publication&id='.$publication['id']; ?>" class="table-btn"><span class="glyphicon glyphicon-eye-open"></span></a>
                                </td>
                                <td>
                                    <a href="<?php echo url('Cms/change').'?type=publication&id='.$publication['id']; ?>" class="table-btn"><span class="glyphicon glyphicon-edit"></span></a>
                                </td>
                                <td>
                                    <a href="#" class="table-btn delete-btn" id="<?php echo $publication['id']; ?>"><span class="glyphicon glyphicon-trash"></span></a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<script>
    post_data = 't='+Math.random()+'&type=publication&id=';
