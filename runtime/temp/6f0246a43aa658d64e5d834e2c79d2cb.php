<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\wamp64\www\project\iotstudio/application/index\view\cms\addNotice.html";i:1494166395;s:70:"D:\wamp64\www\project\iotstudio/application/index\view\cms\header.html";i:1494165839;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-2">
            ...
            <a href="<?php echo url('Cms/notice'); ?>" class="list-group-item">所有公告</a>
            <a href="#" class="list-group-item  disabled">添加公告</a>
        </div>
        <div class="col-sm-10">
            <ol class="breadcrumb">
                <li class="active">公告管理
                </li>
                <li class="active">添加公告
                </li>
            </ol>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" action="<?php echo url('Cms/add'); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="editor" name="text" placeholder="添加公告" autofocus></textarea>
                        </div>
                        <p class="submit-p">
