		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-2">
					...
					<a href="<?php echo url('Cms/member'); ?>" class="list-group-item ">所有成员</a>
					<a href="<?php echo url('Cms/addMember'); ?>" class="list-group-item">添加新成员</a>
					<a href="#" class="list-group-item disable">修改成员</a>
				</div>
				<div class="col-sm-10">
					<ol class="breadcrumb">
						<li class="active">成员管理
						</li>
						<li class="active">添加新成员
						</li>
					</ol>
