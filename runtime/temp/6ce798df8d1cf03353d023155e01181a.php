<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\wamp64\www\project\iotstudio/application/index\view\cms\addtrend.html";i:1493884982;s:70:"D:\wamp64\www\project\iotstudio/application/index\view\cms\header.html";i:1493884910;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="example-navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a class="icon-bar" href="#">动态管理</a>
                </li>
                <li><a href="#">文章管理</a>
                </li>
                <li><a href="#">项目管理</a>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-2">
            ...
            <a href="#" class="list-group-item  disabled">添加动态</a>
        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" action="<?php echo url('Cms/addTrend'); ?>" method="post">
                        <div class="form-group">
                            <label for="name">动态名称：</label>
                            <input type="text" class="form-control" id="name" name="trend_name" placeholder="请输入名称">
                        </div>
                        <div class="form-group">
                            <label for="name">动态内容:</label>
                            <textarea class="form-control" id="editor" name="trend_text" placeholder="添加动态" autofocus></textarea>
                        </div>
                        <p class="submit-p">
