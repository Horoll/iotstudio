<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"G:\wamp\wamp64\www\iotstudio/application/index\view\cms\addPublication.html";i:1499938277;s:67:"G:\wamp\wamp64\www\iotstudio/application/index\view\cms\header.html";i:1495203267;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="container-fluid">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-2">
					<a href="#" class="list-group-item active">发表 管理</a>
					<a href="<?php echo url('Cms/publication'); ?>" class="list-group-item ">所有发表 </a>
					<a href="" class="list-group-item disable">添加新发表 </a>
				</div>
				<div class="col-sm-10">
					<ol class="breadcrumb">
						<li class="active">发表 管理
						</li>
